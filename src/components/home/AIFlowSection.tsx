...
export default function AIFlowSection() {
  return (
    <section className="relative min-h-screen snap-start bg-[#f8f7f3] overflow-hidden py-16 lg:py-24 flex items-center justify-center">
      ...
      <h2 className="absolute top-4 left-4 lg:top-10 lg:left-10 text-[18vw] md:text-[14vw] lg:text-[13vw] font-black uppercase text-black/[0.03] leading-none pointer-events-none">
        AI FLOW
      </h2>

      <div className="relative z-10 w-full max-w-[1800px] px-4 md:px-8">
        <motion.div
        ...
        >
          <p className="uppercase tracking-[0.4em] text-xs text-black/50 mb-4">
            Alur Pengenalan
          </p>

          <h2 className="text-3xl md:text-5xl lg:text-6xl font-black leading-[0.9] text-black">
            Alur Kerja Deteksi
            <br />
            Sampah
          </h2>
        ...
        <div className="overflow-x-auto lg:overflow-visible pb-4">
          <div className="flex items-start gap-4 min-w-max lg:min-w-0 lg:w-full lg:justify-between">
            {/* STEP 1 */}
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-[280px] lg:w-[190px] shrink-0"
            >
              ...
              <div className="border-2 border-dashed border-black/20 rounded-[22px] bg-white p-4">
                <div className="bg-[#f4f4f4] rounded-2xl overflow-hidden border border-black/10">
                  <Image
                    ...
                    width={250}
                    height={320}
                    className="object-contain h-[180px] lg:h-[220px] mx-auto"
                  />
                </div>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-xs text-black/60 mt-2 leading-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-[280px] lg:w-[210px] shrink-0"
            >
              <p className="font-black text-lg mb-5 text-black">
                Preprocessing
              </p>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-[300px] lg:w-[240px] shrink-0"
            >
              ...
              <div className="border-2 border-dashed border-[#7db4ff] rounded-[22px] bg-white p-5">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={item}
                      className="border border-[#b8d7ff] rounded-xl py-2 px-3 text-center font-semibold text-sm text-black"
                    >
                      {item}
                    </div>
                  ))}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-[300px] lg:w-[230px] shrink-0"
            >
              ...
              <div className="border-2 border-dashed border-[#8fd88b] rounded-[22px] bg-white p-4">
                <div className="space-y-2">
                  {[
                    ...
                    <div
                      key={item}
                      className="flex items-center gap-3 border border-[#d5f0d2] rounded-xl px-3 py-2 text-black"
                    >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-[280px] lg:w-[200px] shrink-0"
            >
              ...
              <div className="border-2 border-dashed border-[#c78cff] rounded-[22px] bg-white p-5 text-center">
                <div className="w-24 h-24 lg:w-28 lg:h-28 rounded-full bg-[#4da3ff] mx-auto flex items-center justify-center text-4xl lg:text-5xl text-white mb-6">
                  ♻️
                </div>
                ...
                <p className="mt-3 text-black/60 text-xs leading-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-[320px] lg:w-[250px] shrink-0"
            >
              ...
              <div className="border-2 border-dashed border-[#7bd5dd] rounded-[22px] bg-white p-4">
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={item.title}
                      className="flex items-center gap-3 border border-black/10 rounded-2xl p-3"
                    >
...
function Arrow() {
  return (
    <div className="pt-[160px] shrink-0">
